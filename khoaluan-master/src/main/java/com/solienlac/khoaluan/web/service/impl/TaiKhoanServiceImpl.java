...
import com.solienlac.khoaluan.web.common.dto.ThongTinGiangVienDto;
import com.solienlac.khoaluan.web.common.dto.ThongTinPhuHuynhDto;
    ...
    public CheckAuthResponse checkAuth(CheckAuthParam checkAuthParam) {
        ...
        try {
            ...
            if (e instanceof ExpiredJwtException) {
                 throw new IllegalArgumentException("Can not indentify Token !!!!!");
            }
